        ...
        <div className="ch-layout">
            <aside className="ch-sidebar-global">
                <div className="ch-global-logo">
                    <Link to="/traces" className="flex items-center gap-2">
                ...
                {showOrgSelector && (
                    <div className="ch-org-selector hover:bg-white/5 transition-colors">
                        ...
                        <div className="flex-1 truncate font-medium">My Organization</div>
                ...
                <div className="p-3 bg-bg-sidebar flex items-center justify-between cursor-pointer hover:bg-white/5" onClick={() => {
                    // User menu dropdown would go here
                }}>
                    <div className="flex items-center gap-2">
                        <div className="w-6 h-6 rounded-full bg-accent flex items-center justify-center text-black text-xs font-bold">M</div>
                        <div className="text-[13px]">user@example.com</div>
                    </div>
                </div>
