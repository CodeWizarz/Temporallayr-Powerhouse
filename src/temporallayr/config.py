...
class TemporalLayrConfig(BaseModel):
    ...
    def from_env(cls) -> TemporalLayrConfig:
        return cls(
            ...
            debug_mode=os.getenv("TEMPORALLAYR_DEBUG_MODE", "false").lower()
            in {"1", "true", "yes"},
            ...
            postgres_dsn=os.getenv("DATABASE_URL") or os.getenv("TEMPORALLAYR_POSTGRES_DSN"),
            ...
            clickhouse_secure=os.getenv("TEMPORALLAYR_CLICKHOUSE_SECURE", "true").lower()
            != "false",
